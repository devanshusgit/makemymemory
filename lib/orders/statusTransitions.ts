/**
 * Valid order state transitions — the single source of truth.
 *
 * Lives in lib/ rather than in a route file because a Next.js App Router
 * route.ts may only export route handlers and a few config symbols; exporting
 * this helper from there failed the build's route-type check.
 */
