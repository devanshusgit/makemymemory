...
3.6 Safety & Compliance: To meet our tax and regulatory obligations, and to detect, prevent, or address fraud, security breaches, or technical issues.
...
4.1 Payment Gateway – Razorpay: We share transactional data (name, email, phone, amount) with Razorpay for the purpose of processing your payments, using their secure, trusted platform.
...
4.5 Business Transfer: In the event of a merger, acquisition, or sale of assets, your personal information may be transferred as part of that transaction, subject to the same privacy protections.`,
  },
  {
    ...
    body: `5.1 All payment transactions on this Website are processed securely through Razorpay.
...
6.4 We do not use cookies to collect sensitive personal information or to track you across third-party websites without your consent.`,
  },
  {
    ...
    body: `7.1 We retain your personal information for as long as necessary to fulfil the purposes described in this policy, or for our own record-keeping.
...
7.4 Upon written request, we will delete your personal data where we're not required to keep it for another reason (see Section 9 – Your Rights).`,
  },
  {
    heading: "8. Data Security",
    body: `8.1 We implement reasonable administrative, technical, and physical security measures to protect your personal information against unauthorised access, loss, misuse, or disclosure.

8.2 Security measures include: encryption for data in transit, secure password hashing, access controls limiting employee access to customer data on a need-to-know basis, and regular security reviews.

8.3 While we take every reasonable precaution, no method of electronic transmission or storage is 100% secure. We cannot guarantee absolute security of your data. If a security breach occurs that is likely to result in harm to you, we will notify you.`,
  },
  {
    heading: "9. Your Rights",
    body: `As part of our commitment to transparency, you have the following rights with respect to your personal data:
...
To exercise any of these rights, please email us at support@makemymemory.in with the subject line "Data Privacy Request".`,
  ...
  {
    heading: "12. Privacy Contact",
    body: `If you have any privacy-related questions or concerns, here's who to reach out to:
